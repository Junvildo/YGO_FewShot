...
img = cv2.imread('yolo_detected/detected_object_8.jpg')
...
# Extract artwork function from card2art.py
...
# Detect rectangles, correct perspective, and extract artwork
for cnt in contours:
    ...
    if len(approx) >= 4 and cv2.contourArea(cnt) > lp_area:
        ...
        cv2.imshow("Extracted Artwork", art)
